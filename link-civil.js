...
//   CIVIL_PURSUIT_PATH  - path to civil-pursuit repo (default: ../civil-pursuit-new)
...
//   export CIVIL_PURSUIT_PATH="../civil-pursuit-new"
//   export CIVIL_SERVER_PATH="../civil-server-update"
//   export CIVIL_CLIENT_PATH="../civil-client"
//
// Junctions created:
//   enciv-home/node_modules/civil-pursuit -> ${CIVIL_PURSUIT_PATH}
//   enciv-home/node_modules/civil-server  -> ${CIVIL_SERVER_PATH}
//   enciv-home/node_modules/civil-client  -> ${CIVIL_CLIENT_PATH}
//   ${CIVIL_PURSUIT_PATH}/node_modules/react     -> enciv-home/node_modules/react
//   ${CIVIL_PURSUIT_PATH}/node_modules/react-dom -> enciv-home/node_modules/react-dom
//   ${CIVIL_PURSUIT_PATH}/node_modules/react-jss -> enciv-home/node_modules/react-jss
...
const pursuitDir = path.resolve(homeDir, process.env.CIVIL_PURSUIT_PATH || '../civil-pursuit-new')
...
const pursuitNm = path.join(pursuitDir, 'node_modules')
...
if (process.argv.includes('--unlink')) {
  ...
  ;[
    path.join(homeNm, 'civil-pursuit'),
...
;[
  ...
  path.join(homeNm, 'civil-server'),
  path.join(homeNm, 'civil-client'),
  path.join(pursuitNm, 'react'),
  path.join(pursuitNm, 'react-dom'),
  path.join(pursuitNm, 'react-jss'),
...
run(`mklink /j "${path.join(homeNm, 'civil-pursuit')}" "${pursuitDir}"`)
...
reactPkgs.forEach(pkg => {
  run(`mklink /j "${path.join(pursuitNm, pkg)}" "${path.join(homeNm, pkg)}"`)
...
console.log('')
console.log('✓ civil-pursuit, civil-server, and civil-client linked successfully')
console.log('')
